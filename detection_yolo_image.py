...
if __name__ == "__main__":
    ...
    # yolo_model_path = "models/yolo/yolov8x.pt"
    output_csv_path = "output/detection_yolo_image_x_full_e300/results.csv"
    image_format = 'PNG'
    output_images_folder = "output/detection_yolo_image_x_full_e300/images"
    output_video_folder = "output/detection_yolo_image_x_full_e300/video"
