...
def save_and_plot_traffic_data(groundtruth_data, prediction_data, groundtruth_speed, prediction_speed, output_path):
    ...
    plt.title('Average Speed Over Time (pixels/frame)')
    plt.xlabel('Time Window')
...
if __name__ == "__main__":
    ...
    prediction_csv_path = 'output/tracking_yolo_image/results.csv'
    frame_window = 30
    ...
    save_and_plot_traffic_data(groundtruth_data, prediction_data, groundtruth_speed, prediction_speed, output_path)