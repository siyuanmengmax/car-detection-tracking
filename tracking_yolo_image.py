...
if __name__ == "__main__":
    ...
    output_csv_path = "output/tracking_yolo_image_x_full_e300/results.csv"
    output_video_folder = "output/tracking_yolo_image_x_full_e300/video"
    output_images_folder = "output/tracking_yolo_image_x_full_e300/images"
    image_format = 'PNG'
