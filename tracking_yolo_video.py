...
if __name__ == "__main__":
    ...
    output_csv_path = "output/tracking_yolo_video/results.csv"
    output_video_folder = "output/tracking_yolo_video/video"
    output_images_folder = "output/tracking_yolo_video/images"
