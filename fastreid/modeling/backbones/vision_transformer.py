...
* Weights ported from official jax impl for 384x384 base and small new_models, 16x16 and 32x32 patches.
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, stride_size=16, in_chans=3, embed_dim=768,
        ...
        super().__init__()
        self.num_features = self.embed_dim = embed_dim  # num_features for consistency with other new_models
        ...
        try:
            ...
            for k, v in state_dict.items():
                ...
                if 'patch_embed.proj.weight' in k and len(v.shape) < 4:
                    # For old new_models that I trained prior to conv based patchification
