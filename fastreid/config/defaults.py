...
# Path to a checkpoint file to be loaded to the model. You can find available new_models in the model zoo.
_C.MODEL.WEIGHTS = ""
...
# This is not useful (at least for recent new_models). You should avoid
...
# for about 10k iterations. It usually hurts total time, but can benefit for certain new_models.
