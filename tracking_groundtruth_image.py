...
if __name__ == "__main__":
    ...
    ground_truth_path = "dataset/Car Tracking & Object Detection/annotations.csv"
    output_csv_path = "output/tracking_groundtruth_image_new/results.csv"
    output_video_folder = "output/tracking_groundtruth_image_new/video"
    output_images_folder = "output/tracking_groundtruth_image_new/images"
    image_format = 'PNG'
    main(image_folder, ground_truth_path, output_csv_path, output_video_folder,output_images_folder,image_format)