...
if __name__ == "__main__":
    ...
    output_csv_path = "output/tracking_detr_image/results.csv"
    output_video_folder = 'output/tracking_detr_image/video'
    output_images_folder = "output/tracking_detr_image/images"
    image_format = 'PNG'
