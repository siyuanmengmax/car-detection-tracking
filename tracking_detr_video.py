...
def main(video_path, detr_model_path, output_csv_path, output_video_folder,output_images_folder):
    ...
    while cap.isOpened():
        ...
        for score, label, box in zip(results["scores"], results["labels"], results["boxes"]):
            ...
            # print(cls_name, conf, x1, y1, x2, y2)
...
if __name__ == "__main__":
    ...
    output_csv_path = "output/tracking_detr_video/results.csv"
    output_video_folder = "output/tracking_detr_video/video"
    output_images_folder = "output/tracking_detr_video/images"
