...
if __name__ == '__main__':
    predictions = load_csv('output/detection_yolo_image/results.csv')
    ground_truths = load_csv('dataset/Car Tracking & Object Detection/annotations.csv')
    average_precision, average_recall = main(predictions, ground_truths)
    print(f"Mean Average Precision: {average_precision}, Mean Average Recall: {average_recall}")
