    ...
    while True:
        ...
        if detr_model_path in ["facebook/detr-resnet-50", "facebook/detr-resnet-101"]:
            ...
            for score, label, box in zip(results["scores"], results["labels"], results["boxes"]):
                ...
                conf = score.item()
                cls_id = model.config.id2label[label.item()]
...
if __name__ == "__main__":
    ...
    output_csv_path = "output/detection_detr_video_50_full_e300/results.csv"
    output_images_folder = "output/detection_detr_video_50_full_e300/images"
    output_video_folder = "output/detection_detr_videO_50_full_e300/video"
